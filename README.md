...
因为 CCTV 最近又开始抽风，导致一些近期重新加密的视频可能会解密不了（见 <https://github.com/xiaoxi-ij478/cctv-h5e-decrypt/issues/3>）。

而且他们最新写的 worker 如果解密多了会出现越界访问的情况，我目前还没有什么对策。在这期间，暂且用 master 上的脚本凑活两天。

如果你也想和我一起研究，欢迎来 issue 区讨论。
